  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <Image 
                ...
                src={ring} 
              />
            {/* <!-- <img src="./ring5.png" style="width:10%;" alt=""> --> */}
            <a style={{width:"5%"}}href="#">
              
              {/* <Image src="../assets/ring5.png" style={{width:"100%", display:"block"}} alt=""/> */}
    ...
    <main>
        ...
        <div className={`${indexStyle.mainHeader}`}>
            <h2>
                Kom og gør vores bryllupsdag speciel! <br/> <a href="https://goo.gl/maps/63kBtwV32YH3Zo318">"Nazar Selvskabslokaler"</a> <br/>d. 18/5 klokken 17:00 - 02:00
            </h2>
        </div>
        <div className={`container ${indexStyle.containers}`}>
            <article className={`row text-center ${indexStyle.section01}`} id="tidsplan">
                ...
                {/* <div style={{border: '2px solid #0ab3d7',width:"600px",height:"550px",position:"relative", marginLeft:"auto", marginRight:"auto"}}> */}
                  <Image
                      src={img01}
